...
[Store](https://github.com/navify/rindo-store) is a lightweight shared state library by the rindo core team. It implements a simple key/value map that efficiently re-renders components when necessary.
