...
prerendering, as well as for the Navify framework. However, like Rindo
 components, the hydrate app itself is not restricted to one framework.
...
*Example taken from Navify Core*
