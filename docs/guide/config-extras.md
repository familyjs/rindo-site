...
Note: `buildEs5: 'prod'` was also set in the config since this example needs to support legacy browsers. See the [buildEs5 config](config#buildes5) for more information.
...
and use a bundler such as Vite to lazily load the Rindo library's components.
