...
To see a list of all notable changes to Rindo, please refer to the 
<a href="https://github.com/navify/rindo/releases" target="_blank" rel="noreferrer noopener">releases page</a>.
