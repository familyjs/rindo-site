...
::: warning
Note: Children components should not know about or reference their parent components.  This allows Rindo to
...
To do validation of a Prop, you can use the [@Watch()](./reactive-data.md#watch-decorator) decorator:
