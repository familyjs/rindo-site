---
title: Rindo Style Guide
sidebar_label: Style Guide
description: Rindo Style Guide
slug: /style-guide
---
...
:::note
In order to enforce this (or your team's) style guide, we recommend leveraging a static analysis tool like [ESLint](https://eslint.org/). [@rindo-community/eslint-plugin](https://www.npmjs.com/package/@rindo-community/eslint-plugin) provides rules specifically for writing Rindo components.
:::
...
export class Something {
   ...
   * Requires JSDocs for public API documentation.
   */
  @Event() fmlClose: EventEmitter;
  @Event() fmlDrag: EventEmitter;
  @Event() fmlOpen: EventEmitter;
