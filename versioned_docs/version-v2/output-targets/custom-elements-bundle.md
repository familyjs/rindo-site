---
title: (Deprecated) Bundling Custom Elements with Rindo
sidebar_label: dist-custom-elements-bundle
description: Bundling Custom Elements with Rindo
...
Your component library can be easily distributed on NPM, similar to how [`@familyjs/core`](https://www.npmjs.com/package/@familyjs/core) does it. From there, consumers of your library can decide how to import your library into their project. For the `dist-custom-elements-bundle`, the default import location would be `my-library/dist/custom-elements-bundle`, but this can get further configured within the `package.json` file.
