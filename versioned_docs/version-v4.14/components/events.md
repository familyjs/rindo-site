...
There is **NOT** such a thing as *rindo events*, instead, Rindo encourages the use of [DOM events](https://developer.mozilla.org/en-US/docs/Learn/JavaScript/Building_blocks/Events).
